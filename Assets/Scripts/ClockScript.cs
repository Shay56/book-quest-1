...
{ 
   ...
   private IEnumerator UpdateClock()
    ...
    private void ClockSetTime(int Seconds,int Minutes,int Hours)
    {
        ...
        SecondsPointer.eulerAngles += (Vector3.left) * 360 * LerpSeconds;
        MinutesPointer.eulerAngles += Vector3.left * 360 * LerpMinutes;
        HoursPointer.eulerAngles += (Vector3.left * 360 * LerpHours) + (Vector3.left * 30 * LerpMinutes);
